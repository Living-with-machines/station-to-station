...
def find_deezymatch_candidates(gazetteer, quicks_df, quicks_query_column, dm_model, inputfile, candidates, queries, candrank_metric, candrank_thr, num_candidates):
    ...
    format_for_candranker("../processed/deezymatch/query_toponyms/" + queries + "_" + quicks_query_column, unique_placenames_array)
    
    # generate vectors for queries (specified in dataset_path) 
    # using a model stored at pretrained_model_path and pretrained_vocab_path 
    start_time = time.time()
    dm_inference(input_file_path="../processed/deezymatch/models/" + dm_model + "/" + inputfile + ".yaml",
                 dataset_path="../processed/deezymatch/query_toponyms/" + queries + "_" + quicks_query_column + ".txt", 
                 ...
                 inference_mode="vect",
                 scenario="../processed/deezymatch/query_vectors/" + queries + "_" + quicks_query_column + "_" + dm_model)
    ...
    combine_vecs(rnn_passes=["fwd", "bwd"], 
                 input_scenario="../processed/deezymatch/query_vectors/" + queries + "_" + quicks_query_column + "_" + dm_model, 
                 output_scenario="../processed/deezymatch/combined/" + queries + "_" + quicks_query_column + "_" + dm_model, 
                 print_every=1000)
    elapsed = time.time() - start_time
    ...
    start_time = time.time()
    candidates_pd = \
        candidate_ranker(query_scenario="../processed/deezymatch/combined/" + queries + "_" + quicks_query_column + "_" + dm_model,
                         ...
                         output_path="../processed/deezymatch/ranker_results/" + queries + "_" + quicks_query_column + "_" + candidates + "_" + dm_model + "_" + candrank_metric + str(num_candidates), 
                         pretrained_model_path="../processed/deezymatch/models/" + dm_model + "/" + dm_model + ".model", 
                         pretrained_vocab_path="../processed/deezymatch/models/" + dm_model + "/" + dm_model + ".vocab")
    elapsed = time.time() - start_time
